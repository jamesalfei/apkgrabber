...
public class DownloadUtil {
	...
	static public void launchBrowser(Context context, String url) {
		Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
		context.startActivity(browserIntent);
	}

	static public long downloadFile(Context context, String url, String cookie, String name) throws IOException {
	...
	static public long downloadFileDM(Context context, String url, String cookie, String name) throws IOException {
	...
	static public void deleteDownloadedFiles(@NonNull final Context context) {
	...
	static public void deleteDownloadedFile(@NonNull final Context context, final long id) {
		new Thread(new Runnable() {
			@Override
			public void run() {
				try {
	...
	static public long downloadFileDirect(@NonNull final Context context, @NonNull String url, @Nullable String cookie, String name) {
	...
	static public File downloadFile(@NonNull final Context context, @NonNull String url, @Nullable String cookie) {
		try {
			OkHttpClient client = new OkHttpClient();
			Request r = new Request.Builder().url(url).addHeader("Cookie", cookie).build();
