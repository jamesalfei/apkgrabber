...
public class FileUtil {
	...
	static public boolean inputStreamToFile(InputStream input, File file) {
		try {
	...
	static public boolean installApk(String path) throws Exception {
	...
	static public File getRandomFile(Context context) throws IOException {
