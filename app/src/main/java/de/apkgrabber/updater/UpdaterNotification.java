...
public class UpdaterNotification {
	...
	public UpdaterNotification(Context context, int maxApps) {
		mContext = context;
		mMaxApps = maxApps;
	...
	public void increaseProgress(int numberOfUpdates) {
	...
	public void finishNotification(int numberOfUpdates) {
		// Prevent NPE
	...
	private boolean doNotification(int numberOfUpdates) {
	...
	private String getNotificationProgressString(int max, int progress) {
