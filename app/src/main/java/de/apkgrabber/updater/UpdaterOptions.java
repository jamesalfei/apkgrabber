...
public class UpdaterOptions {
	...
	public List<IgnoreVersion> getIgnoreVersionList() {
		SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(mContext);
		Gson g = new Gson();
		return g.fromJson(sharedPref.getString(mContext.getString(R.string.preferences_general_ignoreversionlist_key), "[]"), new TypeToken<List<IgnoreVersion>>() {
		}.getType());
	}

	public void setIgnoreVersionList(List<IgnoreVersion> l) {
		SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(mContext);
		sharedPref.edit().putString(mContext.getString(R.string.preferences_general_ignoreversionlist_key), new Gson().toJson(l)).apply();
	}
	...
	public void setIgnoreList(List<String> l) {
		...
		SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(mContext);
		sharedPref.edit().putString(mContext.getString(R.string.preferences_general_ignorelist_key), s).apply();
	}
	...
	public void setOwnGsfId(String id) {
		SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(mContext);
	...
	public void setOwnToken(String id) {
		SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(mContext);
