...
public class AppExistsResponseData {
	...
	public void setDeveloper(AppExistsResponseDeveloper developer) {
	...
	public void setApp(AppExistsResponseApp app) {
		this.app = app;
	}
	...
	public void setRelease(AppExistsResponseRelease release) {
	...
	public void setApks(List<AppExistsResponseApk> apks) {
		this.apks = apks;
	}
